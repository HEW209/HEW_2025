...
void GameScene::CreateGridField() {
    ...
    Corner corners[4] =
    {
        { -halfX - offset,  halfZ + offset,  180.0f },  //北西
        {  halfX + offset,  halfZ + offset, -90.0f },  //北東
        {  halfX + offset, -halfZ - offset, 0.0f },  //南東
        { -halfX - offset, -halfZ - offset,   90.0f }   //南西
    };
...
void GameScene::CreateUIObject() {
    // メニュー
    {
        ...
        renderer->GetTransform()->SetPosition(-5.1f, 3.2f, 0.20f);
        renderer->SetSize(120.0f);
    }
    ...
    // メニュー棒
    {
        ...
        renderer->SetUI(true);
        renderer->LoadTexture("Assets/Textures/menu!.png");
        renderer->GetTransform()->SetPosition(-6.0f, 3.2f, 0.20f);
        renderer->SetSize(120.0f);
    }
    ...
    // おく
    {
        ...
        renderer->GetTransform()->SetPosition(5.6f, -2.1f, 0.0f);
        renderer->SetSize(MOZI_SIZE);
